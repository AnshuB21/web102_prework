...
const unfundedStatement =
  unfundedCount === 1
    ...
    : `Currently, ${unfundedCount} games remain unfunded.`;
...
// set the text content of the new element to the template string
newElement.textContent = displayString;
...
runnerUpGameName.innerText = secondGame.name;
